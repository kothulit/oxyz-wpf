...
{
    readonly public static Dictionary<MessengerEvents, Delegate> eventTable = new Dictionary<MessengerEvents, Delegate>();
    static public readonly MessengerMode DEFAULT_MODE = MessengerMode.REQUIRE_LISTENER;

    static public void AddListener(MessengerEvents eventType, Delegate callback)
    {
    ...
    static public void RemoveListener(MessengerEvents eventType, Delegate handler)
    {
    ...
    static public void OnListenerRemoved(MessengerEvents eventType)
    {
    ...
    static public T[] GetInvocationList<T>(MessengerEvents eventType)
    {
        Delegate d;
    ...
    static public void OnBroadcasting(MessengerEvents eventType, MessengerMode mode)
    {
    ...
    static public BroadcastException CreateBroadcastSignatureException(MessengerEvents eventType)
    {
...
public static class Messenger<T>
{
    ...
    static public void AddListener<TReturn>(MessengerEvents eventType, Func<T, TReturn> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void RemoveListener(MessengerEvents eventType, Action<T> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void RemoveListener<TReturn>(MessengerEvents eventType, Func<T, TReturn> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1)
    {
        Broadcast(eventType, arg1, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, Action<TReturn> returnCall)
    {
        Broadcast(eventType, arg1, returnCall, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1, MessengerMode mode)
    {
    ...
    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, Action<TReturn> returnCall, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
...
{
    static public void AddListener(MessengerEvents eventType, Action<T, U> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void AddListener<TReturn>(MessengerEvents eventType, Func<T, U, TReturn> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void RemoveListener(MessengerEvents eventType, Action<T, U> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void RemoveListener<TReturn>(MessengerEvents eventType, Func<T, U, TReturn> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1, U arg2)
    {
        Broadcast(eventType, arg1, arg2, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, U arg2, Action<TReturn> returnCall)
    {
        Broadcast(eventType, arg1, arg2, returnCall, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1, U arg2, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
    ...
    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, U arg2, Action<TReturn> returnCall, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
...
{
    static public void AddListener(MessengerEvents eventType, Action<T, U, V> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void AddListener<TReturn>(MessengerEvents eventType, Func<T, U, V, TReturn> handler)
    {
        MessengerInternal.AddListener(eventType, handler);
    }

    static public void RemoveListener(MessengerEvents eventType, Action<T, U, V> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void RemoveListener<TReturn>(MessengerEvents eventType, Func<T, U, V, TReturn> handler)
    {
        MessengerInternal.RemoveListener(eventType, handler);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1, U arg2, V arg3)
    {
        Broadcast(eventType, arg1, arg2, arg3, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall)
    {
        Broadcast(eventType, arg1, arg2, arg3, returnCall, MessengerInternal.DEFAULT_MODE);
    }

    static public void Broadcast(MessengerEvents eventType, T arg1, U arg2, V arg3, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
    ...
    static public void Broadcast<TReturn>(MessengerEvents eventType, T arg1, U arg2, V arg3, Action<TReturn> returnCall, MessengerMode mode)
    {
        MessengerInternal.OnBroadcasting(eventType, mode);
